...
const ShortenUrlCard: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md mx-auto mt-10 w-full h-auto">
      <div className="mb-10">
        <Input
          id="originalUrl"
      ...
      <div className="mb-10 flex space-x-2">
          <Input label="Short URL" className='shadow-lg rounded-lg' disabled crossOrigin={undefined} />
      ...
      <Button className="bg-gradient-to-r from-blue to-blueGrotto" fullWidth variant='gradient'>
        Shorten URL
      </Button>
    </div>
  );
